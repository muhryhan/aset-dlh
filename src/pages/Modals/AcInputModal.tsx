import AcFormInput from "../../components/formInput/AcFormInput";
...
export default function AcInputModal({
  ...
  return (
    <div className="fixed inset-0 z-[100000] flex items-center justify-center bg-black/60 p-4">
      <PageMeta
        title="Input Data Ac"
        description="Halaman Input Data Ac"
      />
      ...
      <div className="relative bg-white dark:bg-dark-800 rounded-xl shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col">
        ...
        <div className="overflow-y-auto px-6 pb-6">
          <AcFormInput onSuccess={onSuccess} />
        </div>
      </div>
    </div>
  );
